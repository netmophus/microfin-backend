...
def test_le_siege_est_cree_avec_le_nom_demande_sur_base_vierge(
    ...
    # Caisse (CA1/Bloc A/B) : sessions.agency_id ET sessions.poste_id référencent respectivement
    # agencies et postes -> purger avant. poste_assignations référence postes -> purger avant
    # postes. Postes référencent aussi agencies -> purger avant les agences. Mutable (pas de
